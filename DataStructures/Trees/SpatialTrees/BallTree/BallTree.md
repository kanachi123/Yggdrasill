...
**
каждый новый шар делит свое пространство на подшары и каждый шар имеет центр относительно которого группироуем точки в кластеры по длине от этого центра  
то есть мы берем центр  шара по центроиду $1/N*\sum_i(x^i)$
